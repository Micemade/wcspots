...
/***/ "./src/frontend/FeaturedImageBySize.js":
/*!*********************************************!*\
  !*** ./src/frontend/FeaturedImageBySize.js ***!
  \*********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const FeaturedImageBySize = _ref => {
  let {
    productId,
    featuredImageSize,
    name
  } = _ref;
  const [featuredImageSrc, setFeaturedImageSrc] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(null);
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (FeaturedImageBySize);
...
/* harmony import */ var _functions_addToCartPost__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../functions/addToCartPost */ "./src/functions/addToCartPost.js");
/* harmony import */ var _functions_decode__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../functions/decode */ "./src/functions/decode.js");
/* harmony import */ var _FeaturedImageBySize__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./FeaturedImageBySize */ "./src/frontend/FeaturedImageBySize.js");
...
const fetchRenderProducts = (productIds, blockId) => {
  ...
  const SanitizeHTML = (dompurify__WEBPACK_IMPORTED_MODULE_5___default().sanitize);
  ...
  _wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_3___default()({
    ...
    products.forEach(product => {
      ...
      const fallBack = typeof wc === 'object' ? (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)("img", {
        src: wc?.wcSettings?.PLACEHOLDER_IMG_SRC,
        alt: name
      }) : (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)('Product has no featured image', 'wcspots');
      let imageToRender;
      if (!featuredImageSize || featuredImageSize === 'automatic') {
        ...
        imageToRender = hasImages ? (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)("img", (0,_babel_runtime_helpers_extends__WEBPACK_IMPORTED_MODULE_0__["default"])({}, imgSrcSet ? {
          srcSet: imgSrcSet
        } : {}, {
          src: imgSrc,
          alt: name,
          sizes: "(max-width: 599px) 100vw, calc(100vw / 3)"
        ...
        imageToRender = hasImages ? (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_FeaturedImageBySize__WEBPACK_IMPORTED_MODULE_8__["default"], {
          productId: productId,
      ...
      // Product image.
      {
        imageContainer && (0,react_dom__WEBPACK_IMPORTED_MODULE_4__.render)(imageToRender, imageContainer);
      }
      // Product title.
      {
        titleContainer && (0,react_dom__WEBPACK_IMPORTED_MODULE_4__.render)((0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)("a", {
          href: permalink,
          title: (0,_functions_decode__WEBPACK_IMPORTED_MODULE_7__["default"])(name)
        }, (0,_functions_decode__WEBPACK_IMPORTED_MODULE_7__["default"])(name)), titleContainer);
      }
      // Price (HTML sanitized).
      {
        priceContainer && (0,react_dom__WEBPACK_IMPORTED_MODULE_4__.render)((0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)("div", {
          dangerouslySetInnerHTML: {
      ...
      {
        excerptContainer && (0,react_dom__WEBPACK_IMPORTED_MODULE_4__.render)((0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)("div", {
          dangerouslySetInnerHTML: {
      ...
      {
        addToCartContainer && (0,react_dom__WEBPACK_IMPORTED_MODULE_4__.render)((0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.Fragment, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)("a", {
          className: addToCartClasses,
          href: type !== 'simple' || !priceHtml && addToCart?.url,
          title: addToCart?.description,
          onClick: () => {
            {
              type === 'simple' && priceHtml && (0,_functions_addToCartPost__WEBPACK_IMPORTED_MODULE_6__["default"])(event, productId);
            }
          }
        }, addToCart?.text), type === 'simple' && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)("small", {
          className: "view-cart"
        })), addToCartContainer);
      }
    });
...
const AddHotspotEvents = (hotspot, lookBlockInstance) => {
  ...
  const highlightColor = primColor !== null && primColor !== void 0 ? primColor : ' rgba(0, 0, 0, 0.6)';
  if (product) {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (AddHotspotEvents);
...
/* harmony import */ var _hotspotEvents__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./hotspotEvents */ "./src/frontend/hotspotEvents.js");
/* harmony import */ var _addHotspotPopover__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./addHotspotPopover */ "./src/frontend/addHotspotPopover.js");
/* harmony import */ var _functions_hotspotFunctions__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../functions/hotspotFunctions */ "./src/functions/hotspotFunctions.js");
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  wcspotsInstances.forEach(blockInstance => {
    ...
    productHotspots.forEach(hotspot => {
      ...
      if (assocProdId) {
        (0,react_dom__WEBPACK_IMPORTED_MODULE_1__.render)((0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_addHotspotPopover__WEBPACK_IMPORTED_MODULE_4__["default"], {
          assocProdId: assocProdId,
          popoverAtts: JSON.parse(popoverAtts)
        }), eventsHolder);
      }

      // Hotspot highlighting product on hover.
      (0,_hotspotEvents__WEBPACK_IMPORTED_MODULE_3__["default"])(hotspot, blockInstance);
    });
  });
});
})();
